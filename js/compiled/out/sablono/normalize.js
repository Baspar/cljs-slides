...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__20338_SHARP_){
return ((p1__20338_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__20338_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__20340,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__20340;
}
});
...
var len__19529__auto___20343 = arguments.length;
var i__19530__auto___20344 = (0);
while(true){
if((i__19530__auto___20344 < len__19529__auto___20343)){
args__19536__auto__.push((arguments[i__19530__auto___20344]));

var G__20345 = (i__19530__auto___20344 + (1));
i__19530__auto___20344 = G__20345;
continue;
} else {
}
break;
...
var G__20342 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__20342,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__20342;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq20341){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20341));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__20349,(0),null);
var names = cljs.core.nth.call(null,vec__20349,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__20349,tag_name,names){
return (function (p1__20346_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__20346_SHARP_));
});})(matches,vec__20349,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__20349,tag_name,names){
return (function (p1__20347_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__20347_SHARP_));
});})(matches,vec__20349,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__20350){
var vec__20353 = p__20350;
var tag = cljs.core.nth.call(null,vec__20353,(0),null);
var content = cljs.core.nthnext.call(null,vec__20353,(1));
...
var vec__20354 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__20354,(0),null);
var id = cljs.core.nth.call(null,vec__20354,(1),null);
var class$ = cljs.core.nth.call(null,vec__20354,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1505315423469