...
var args26402 = [];
var len__19530__auto___26406 = arguments.length;
var i__19531__auto___26407 = (0);
while(true){
if((i__19531__auto___26407 < len__19530__auto___26406)){
args26402.push((arguments[i__19531__auto___26407]));

var G__26408 = (i__19531__auto___26407 + (1));
i__19531__auto___26407 = G__26408;
continue;
} else {
}
break;
...
var G__26405 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26405,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26405;
}
});
...
var or__18460__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__19530__auto___26413 = arguments.length;
var i__19531__auto___26414 = (0);
while(true){
if((i__19531__auto___26414 < len__19530__auto___26413)){
args__19537__auto__.push((arguments[i__19531__auto___26414]));

var G__26415 = (i__19531__auto___26414 + (1));
i__19531__auto___26414 = G__26415;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19538__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26410){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26411,G__26412,seq26410__$2);
});
...
var line = cljs.core.get.call(null,map__26419__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26419__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26419,map__26419__$1,file,line,column){
return (function (p1__26416_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26416_SHARP_));
});})(map__26419,map__26419__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__19385__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__19385__auto__,prefer_table__19386__auto__,method_cache__19387__auto__,cached_hierarchy__19388__auto__,hierarchy__19389__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__18460__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__18460__auto__)){
return or__18460__auto__;
} else {
...
var temp__4657__auto___26421 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26421)){
var message_26422 = temp__4657__auto___26421;
cljs.core.println.call(null,message_26422);
} else {
}
...
var temp__4657__auto___26423 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26423)){
var message_26424 = temp__4657__auto___26423;
cljs.core.println.call(null,message_26424);
} else {
}
...
var temp__4655__auto__ = (function (){var and__18448__auto__ = typeof exception.stack === 'string';
if(and__18448__auto__){
var G__26430 = exception.stack;
var G__26430__$1 = (((G__26430 == null))?null:clojure.string.split_lines.call(null,G__26430));
var G__26430__$2 = (((G__26430__$1 == null))?null:cljs.core.get.call(null,G__26430__$1,depth));
if((G__26430__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26430__$2);
}
} else {
...
var vec__26431 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26431,(0),null);
var column = cljs.core.nth.call(null,vec__26431,(1),null);
var vec__26432 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26432,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26432,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26432,(2),null);
...
var m__$1 = (function (){var G__26434 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26434) {
case "fail":
...
var G__26440 = (function (){var G__26439 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26439);
} else {
return G__26439;
}
})();
...
return cljs.core.vary_meta.call(null,G__26442,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e26445){var e = e26445;
var G__26446 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26446) {
...
var vec__26449 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26449,(0),null);
var types = vec__26449;
...
return cljs.core.map.call(null,(function (p__26457){
var vec__26458 = p__26457;
var ns = cljs.core.nth.call(null,vec__26458,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26458,(1),null);
return ((function (vec__26458,ns,vars__$1){
return (function (){
...
var G__26459 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26459) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1){
return (function (){
var seq__26460 = cljs.core.seq.call(null,vars__$1);
var chunk__26461 = null;
var count__26462 = (0);
var i__26463 = (0);
while(true){
if((i__26463 < count__26462)){
var v = cljs.core._nth.call(null,chunk__26461,i__26463);
var temp__4657__auto___26465 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26465)){
var t_26466 = temp__4657__auto___26465;
each_fixture_fn.call(null,((function (seq__26460,chunk__26461,count__26462,i__26463,t_26466,temp__4657__auto___26465,v,each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26466)));
});})(seq__26460,chunk__26461,count__26462,i__26463,t_26466,temp__4657__auto___26465,v,each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1))
);
} else {
}

var G__26467 = seq__26460;
var G__26468 = chunk__26461;
var G__26469 = count__26462;
var G__26470 = (i__26463 + (1));
seq__26460 = G__26467;
chunk__26461 = G__26468;
count__26462 = G__26469;
i__26463 = G__26470;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__26460);
if(temp__4657__auto__){
var seq__26460__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26460__$1)){
var c__19271__auto__ = cljs.core.chunk_first.call(null,seq__26460__$1);
var G__26471 = cljs.core.chunk_rest.call(null,seq__26460__$1);
var G__26472 = c__19271__auto__;
var G__26473 = cljs.core.count.call(null,c__19271__auto__);
var G__26474 = (0);
seq__26460 = G__26471;
chunk__26461 = G__26472;
count__26462 = G__26473;
i__26463 = G__26474;
continue;
} else {
var v = cljs.core.first.call(null,seq__26460__$1);
var temp__4657__auto___26475__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26475__$1)){
var t_26476 = temp__4657__auto___26475__$1;
each_fixture_fn.call(null,((function (seq__26460,chunk__26461,count__26462,i__26463,t_26476,temp__4657__auto___26475__$1,v,seq__26460__$1,temp__4657__auto__,each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26476)));
});})(seq__26460,chunk__26461,count__26462,i__26463,t_26476,temp__4657__auto___26475__$1,v,seq__26460__$1,temp__4657__auto__,each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1))
);
} else {
}

var G__26477 = cljs.core.next.call(null,seq__26460__$1);
var G__26478 = null;
var G__26479 = (0);
var G__26480 = (0);
seq__26460 = G__26477;
chunk__26461 = G__26478;
count__26462 = G__26479;
i__26463 = G__26480;
continue;
}
} else {
...
});})(each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1))
);
});})(each_fixture_fn,G__26459,env,once_fixtures,each_fixtures,vec__26458,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1470998057074