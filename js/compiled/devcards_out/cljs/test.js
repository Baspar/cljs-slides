...
var args26412 = [];
var len__19529__auto___26416 = arguments.length;
var i__19530__auto___26417 = (0);
while(true){
if((i__19530__auto___26417 < len__19529__auto___26416)){
args26412.push((arguments[i__19530__auto___26417]));

var G__26418 = (i__19530__auto___26417 + (1));
i__19530__auto___26417 = G__26418;
continue;
} else {
}
break;
...
var G__26415 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26415,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26415;
}
});
...
var len__19529__auto___26423 = arguments.length;
var i__19530__auto___26424 = (0);
while(true){
if((i__19530__auto___26424 < len__19529__auto___26423)){
args__19536__auto__.push((arguments[i__19530__auto___26424]));

var G__26425 = (i__19530__auto___26424 + (1));
i__19530__auto___26424 = G__26425;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26420){
var G__26421 = cljs.core.first.call(null,seq26420);
var seq26420__$1 = cljs.core.next.call(null,seq26420);
var G__26422 = cljs.core.first.call(null,seq26420__$1);
var seq26420__$2 = cljs.core.next.call(null,seq26420__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26421,G__26422,seq26420__$2);
});
...
var file = cljs.core.get.call(null,map__26429__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26429__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26429__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26429,map__26429__$1,file,line,column){
return (function (p1__26426_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26426_SHARP_));
});})(map__26429,map__26429__$1,file,line,column))
...
var temp__4657__auto___26431 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26431)){
var message_26432 = temp__4657__auto___26431;
cljs.core.println.call(null,message_26432);
} else {
}
...
var temp__4657__auto___26433 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26433)){
var message_26434 = temp__4657__auto___26433;
cljs.core.println.call(null,message_26434);
} else {
}
...
var G__26440 = exception.stack;
var G__26440__$1 = (((G__26440 == null))?null:clojure.string.split_lines.call(null,G__26440));
var G__26440__$2 = (((G__26440__$1 == null))?null:cljs.core.get.call(null,G__26440__$1,depth));
if((G__26440__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26440__$2);
}
} else {
...
var vec__26441 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26441,(0),null);
var column = cljs.core.nth.call(null,vec__26441,(1),null);
var vec__26442 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26442,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26442,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26442,(2),null);
...
var m__$1 = (function (){var G__26444 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26444) {
case "fail":
...
var G__26450 = (function (){var G__26449 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26449);
} else {
return G__26449;
}
})();
...
return cljs.core.vary_meta.call(null,G__26452,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e26455){var e = e26455;
var G__26456 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26456) {
...
var vec__26459 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26459,(0),null);
var types = vec__26459;
...
return cljs.core.map.call(null,(function (p__26467){
var vec__26468 = p__26467;
var ns = cljs.core.nth.call(null,vec__26468,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26468,(1),null);
return ((function (vec__26468,ns,vars__$1){
return (function (){
...
var G__26469 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26469) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1){
return (function (){
var seq__26470 = cljs.core.seq.call(null,vars__$1);
var chunk__26471 = null;
var count__26472 = (0);
var i__26473 = (0);
while(true){
if((i__26473 < count__26472)){
var v = cljs.core._nth.call(null,chunk__26471,i__26473);
var temp__4657__auto___26475 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26475)){
var t_26476 = temp__4657__auto___26475;
each_fixture_fn.call(null,((function (seq__26470,chunk__26471,count__26472,i__26473,t_26476,temp__4657__auto___26475,v,each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1){
return (function (){
...
});})(seq__26470,chunk__26471,count__26472,i__26473,t_26476,temp__4657__auto___26475,v,each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1))
);
} else {
}

var G__26477 = seq__26470;
var G__26478 = chunk__26471;
var G__26479 = count__26472;
var G__26480 = (i__26473 + (1));
seq__26470 = G__26477;
chunk__26471 = G__26478;
count__26472 = G__26479;
i__26473 = G__26480;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__26470);
if(temp__4657__auto__){
var seq__26470__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26470__$1)){
var c__19270__auto__ = cljs.core.chunk_first.call(null,seq__26470__$1);
var G__26481 = cljs.core.chunk_rest.call(null,seq__26470__$1);
var G__26482 = c__19270__auto__;
var G__26483 = cljs.core.count.call(null,c__19270__auto__);
var G__26484 = (0);
seq__26470 = G__26481;
chunk__26471 = G__26482;
count__26472 = G__26483;
i__26473 = G__26484;
continue;
} else {
var v = cljs.core.first.call(null,seq__26470__$1);
var temp__4657__auto___26485__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26485__$1)){
var t_26486 = temp__4657__auto___26485__$1;
each_fixture_fn.call(null,((function (seq__26470,chunk__26471,count__26472,i__26473,t_26486,temp__4657__auto___26485__$1,v,seq__26470__$1,temp__4657__auto__,each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26486)));
});})(seq__26470,chunk__26471,count__26472,i__26473,t_26486,temp__4657__auto___26485__$1,v,seq__26470__$1,temp__4657__auto__,each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1))
);
} else {
}

var G__26487 = cljs.core.next.call(null,seq__26470__$1);
var G__26488 = null;
var G__26489 = (0);
var G__26490 = (0);
seq__26470 = G__26487;
chunk__26471 = G__26488;
count__26472 = G__26489;
i__26473 = G__26490;
continue;
}
} else {
...
});})(each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1))
);
});})(each_fixture_fn,G__26469,env,once_fixtures,each_fixtures,vec__26468,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1470497436263